...
angular.module('app', ['ionic', 'ngCordova', 'ngCordovaOauth', 'app.routes', 'app.login', 'app.enterprise', 'app.player', 'ui.utils.masks', 'ionic-datepicker', 'ionic-timepicker', 'angularMoment'])
